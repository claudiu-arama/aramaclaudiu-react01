...
export const UserStats = ({
  ...
  const playedIconClasses = classNames(
    baseIconClasses,
    'text-purple-500',
  );
  const wonIconClasses = classNames(
    baseIconClasses,
    'text-green-500',
  );
  ...
  return (
    <ul className="className">
      <li className={entryClassName}>
        <IoGameController
          className={playedIconClasses}></IoGameController>
      ...
      <li className={entryClassName}>
        <RiEmotionUnhappyLine
          className={lostIconClasses}></RiEmotionUnhappyLine>
